...
import pandas as pd
impress = pd.read_csv("C:/Users/lenovo/Desktop/tp_Thiam/impressions.csv")
clics= pd.read_csv("C:/Users/lenovo/Desktop/tp_Thiam/clics.csv")
achat= pd.read_csv("C:/Users/lenovo/Desktop/tp_Thiam/achats.csv")
...
st.subheader('Prix en fonction du temps')
histo=px.histogram(imp_clic_achat, x='campaign_id', y='price')
